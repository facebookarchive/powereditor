...
var UploadUtils = {
  getChangedAdsFromCampaigns: function(campaigns, callback) {
    models.Ad.findAllBy('campaign_id', utils.pluck(campaigns, 'id'),
      function(ads) {
        ads = ads.filter(function(a) {
          ...
          return a.isChanged() && (!a.hasErrors() || a.isDeleted());
        });
        callback(ads);
      });
  }
