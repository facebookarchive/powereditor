...
var EduWork = view.newClass('ads.adEditor.EduWork', Base, {
    ...
    _setupBindings: function(m) {
        this.child('workplaces').binding({
            model: m,
            modelProp: 'work_networks'
        });
        this.child('colleges').binding({
            model: m,
            modelProp: 'college_networks'
        });
        this.child('college_majors').binding({
            model: m,
            modelProp: 'college_majors'
        });
        this.child('college_years').binding({
            model: m,
            modelProp: 'college_years'
        });
    ...
    _prepare: function(callback) {
      Completion.prepare(['college_majors'], callback);
      Completion.prepare(['workplaces', 'colleges'], fun.FS);
    },
    ...
    _createDom: function(initArgs) {
        ...
        this.content({
            ...
            alumni: { view: 'Radio', name: name,
                text: 'College Grad', value: 3 },
            college: { view: 'Radio', name: name,
                text: 'In College', value: 2 },
            hs: { view: 'Radio', name: name,
                text: 'In High School', value: 1 },
            college_select: { view: 'List', horizontal: false,
                ...
                { view: 'Tokenizer', inline: true, id: 'eduWork-college',
                    ...
                    data: (new LocalDataSource())
                      ...
                      .queryEndpoint({
                        search: Completion.createSearcher('colleges')
                      })
                },
                { view: 'Tokenizer', inline: true, id: 'eduWork-college_major',
                    ...
                    data: (new LocalDataSource())
                      .maxResults(AdEditorConstants.MAX_RESULTS_DEFAULT)
                      .queryEndpoint({
                        search: Completion.createSearcher('college_majors')
                      })
                },
                { view: controls.GraduationYears, childName: 'college_years' }
            ]},
            workplace_label: 'Workplaces',
            workplace: { view: 'Tokenizer', inline: true,
                ...
                data: (new LocalDataSource())
                  .maxResults(AdEditorConstants.MAX_RESULTS_DEFAULT)
                  .queryEndpoint({
                    search: Completion.createSearcher('workplaces')
                  })
            }
        });
