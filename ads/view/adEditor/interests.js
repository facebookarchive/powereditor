...
var fun = require("../../../uki-core/function"),
    ...
    APIDataSource =
        require("../../lib/typeahead/APIDataSource").APIDataSource,
...
var Interests = view.newClass('ads.adEditor.Interests', Base, {
    ...
    _createDom: function(initArgs) {
        ...
        this.content({
            interests: { view: 'Tokenizer', inline: true, id: 'interests',
                addClass: 'textField interests-tokenizer', freeform: true,
                placeholder: 'Enter an interest', childName: 'interests',
                value2info: function(id) {
                    return { id: id, text: id };
                },
                data: (new APIDataSource())
                    .maxResults(AdEditorConstants.MAX_RESULTS_DEFAULT)
                    //using new Ads API if GK is turned on
                    .queryData({ type: 1,
                                 advanced: Env.gk.admarket_keywords_v2 })
                    .queryEndpoint('ads.getKeywordAutocomplete')
            },
            interests_link: {
                view: 'Text',
